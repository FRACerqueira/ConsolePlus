...
#pragma warning restore IDE0130 // Namespace does not match folder structure
{
    ...
    public static class StyleExtensions
    {
        ...
        public static Style Colors(this Style style, Color forecolor) =>
            new(forecolor, style.Background, style.OverflowStrategy);
        ...
        /// <returns>A new <see cref="Style"/> with the specified colors.</returns>
        public static Style Colors(this Style style, Color forecolor, Color backcolor) =>
            new(forecolor, backcolor, style.OverflowStrategy);
